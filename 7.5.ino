...
// version number 5 goes with ILC software v7.5
...
{
  for (int i = 0; i < numPins / 2; i++)
  { // Set All Inputs & Outputs pins to INPUT or READ mode
...
void SetSwitchPinsToInput()
{ // Sets switch pins to INPUT
...
void SetSwitchPinsToOutput()
{ // Set switch pins to OUTPUT
